...
<html lang="en" data-bs-theme="auto">
  <head>
    <script src="<?=siteUrl()?>admin/js/color-modes.js"></script>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="<?=siteUrl()?>">Mordarna</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="<?=siteUrl()?>admin/user/sign-out.php">Sign out</a>
    </div>
  </div>
</header>